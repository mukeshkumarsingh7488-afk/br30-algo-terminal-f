...
import { ArrowRight, CheckCircle2, Cookie, DatabaseZap, Eye, FileText, LockKeyhole, Mail, ShieldCheck, Sparkles, UserCheck } from "lucide-react";
...
const sections = [
  {
    ...
    text: "When you use BR30 Algo Terminal, we may collect basic account details such as your name, email address, login information, profile details, subscription status, and platform activity required to provide access to the service. We may also collect technical information such as browser type, device information, IP address, session activity, and usage logs to improve security and platform performance.",
  },
  {
    icon: UserCheck,
    title: "2. How We Use Your Information",
    text: "We use your information to create and manage your account, provide platform access, improve user experience, process authentication, communicate important updates, maintain security, monitor system usage, prevent misuse, and support product development. We do not sell your personal information.",
  },
  {
    icon: ShieldCheck,
    title: "3. Broker & Trading Data",
    text: "BR30 Algo Terminal may allow users to connect broker accounts through secure broker authorization flows. Broker-related data such as access tokens, connection status, order status, trading logs, strategy activity, and risk settings may be processed only for providing broker connectivity, paper trading, live execution, reporting, and risk management features.",
  },
  {
    icon: LockKeyhole,
    title: "4. Token Security",
    text: "Broker access tokens and sensitive integration data are planned to be handled using secure storage practices, controlled access, and encrypted architecture where applicable. Users should never share passwords, OTPs, API keys, or broker credentials outside official broker authorization pages.",
  },
  {
    icon: Cookie,
    title: "5. Cookies & Tracking",
    text: "We may use cookies, local storage, session storage, or similar technologies to keep users logged in, remember preferences, protect accounts, improve performance, and understand usage behavior. Users may control cookies from their browser settings, but disabling cookies may affect platform functionality.",
  },
  {
    icon: Eye,
    title: "6. Third-Party Services",
    text: "BR30 Algo Terminal may use third-party services for hosting, database, analytics, payments, authentication, email delivery, broker APIs, and security infrastructure. These services may process limited information as required to provide their functionality and are governed by their own privacy policies.",
  },
  {
    icon: FileText,
    title: "7. Data Retention",
    text: "We retain user information only as long as necessary for account access, security, legal compliance, operational records, support, and product improvement. Users may request account-related assistance or data removal by contacting our support email, subject to legal, security, or operational requirements.",
  },
];
        ...
        <main>
          <section className="legal-hero">
            ...
            <div className="landing-container legal-hero-inner">
              ...
              <h1>
                Your Privacy Matters At <span>BR30 Algo Terminal.</span>
              </h1>

              <p>This Privacy Policy explains how BR30 Algo Terminal collects, uses, stores, protects, and handles information when users access our website, dashboard, broker-connect features, automation tools, and related services.</p>
            ...
            <div className="landing-container legal-layout">
              ...
              <div className="legal-content-card">
                <div className="legal-notice" id="intro">
                  ...
                  <div>
                    <h2>Introduction</h2>
                    <p>BR30 Algo Terminal is built as a trading automation platform focused on broker connectivity, strategy building, backtesting, paper trading, live algo execution, reports, and risk-first trading discipline. We respect user privacy and aim to keep data handling clear, secure, and transparent.</p>
                  </div>
                </div>
                ...
                <div className="legal-block">
                  ...
                  <div>
                    ...
                    <p>BR30 Algo Terminal is intended for users who are legally permitted to use trading-related services in their jurisdiction. We do not knowingly collect personal data from children. If we become aware of such data, we may take steps to remove it.</p>
                  </div>
                </div>
                ...
                <div className="legal-block">
                  ...
                  <div>
                    ...
                    <p>We may update this Privacy Policy from time to time to reflect changes in our product, technology, business operations, legal requirements, or security practices. Updated versions will be posted on this page with a revised last updated date.</p>
                  </div>
                </div>
          ...
          <section className="legal-final-section">
            <div className="landing-container legal-final-card">
              ...
              <h2>Privacy, Security & Trust Come First</h2>

              <p>BR30 Algo Terminal is built with a risk-first mindset for traders who care about discipline, safety, and transparency.</p>
