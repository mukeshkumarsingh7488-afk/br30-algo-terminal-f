...
import { ArrowRight, CheckCircle2, FileText, Gavel, LockKeyhole, Mail, Scale, ShieldAlert, ShieldCheck, Sparkles, UserCheck, Zap } from "lucide-react";
...
const termsSections = [
  {
    ...
    text: "By accessing or using BR30 Algo Terminal, you agree to follow these Terms & Conditions. If you do not agree with these terms, you should not use the website, dashboard, broker-connect features, automation tools, or any related BR30 services.",
  },
  {
    icon: FileText,
    title: "2. About BR30 Algo Terminal",
    text: "BR30 Algo Terminal is a trading automation platform designed for broker connectivity, strategy building, backtesting, paper trading, live algo execution, reports, and risk-first trading workflow. The platform may include both active and planned features, and availability may change over time.",
  },
  {
    icon: ShieldCheck,
    title: "3. User Account Responsibility",
    text: "You are responsible for maintaining the confidentiality of your account, login credentials, device access, and any activity performed from your account. You must provide accurate information and must not misuse the platform, attempt unauthorized access, or use the service for illegal activity.",
  },
  {
    icon: LockKeyhole,
    title: "4. Broker Connection & API Access",
    text: "If you connect a broker account, you are responsible for understanding the broker’s terms, API permissions, risks, and trading rules. BR30 Algo Terminal may process broker connection status, access tokens, order data, and trading logs only to provide platform functionality.",
  },
  {
    icon: ShieldAlert,
    title: "5. Trading Risk Disclaimer",
    text: "Trading and investing involve risk. Market losses can happen even when using automation, backtesting, paper trading, indicators, or risk management tools. BR30 Algo Terminal does not guarantee profits, fixed returns, accuracy of signals, or protection from market losses.",
  },
  {
    icon: Zap,
    title: "6. Live Algo Execution",
    text: "Live algo trading may place real broker orders if enabled by the user and supported by the platform. Users must verify strategy logic, risk settings, broker status, capital, margin, instruments, and order behavior before enabling live execution.",
  },
];

const responsibilities = ["Use the platform only for lawful purposes.", "Keep account and broker credentials secure.", "Verify strategies before live execution.", "Set proper risk limits before trading.", "Do not attempt to hack, reverse engineer, or misuse the platform.", "Accept full responsibility for trading decisions and results."];
        ...
        <main>
          <section className="legal-hero">
            ...
            <div className="landing-container legal-hero-inner">
              ...
              <h1>
                Terms For Using <span>BR30 Algo Terminal.</span>
              </h1>

              <p>These Terms & Conditions explain the rules, responsibilities, limitations, and usage conditions for accessing BR30 Algo Terminal, including website pages, dashboard features, broker connectivity, automation tools, and related services.</p>
            ...
            <div className="landing-container legal-layout">
              ...
              <div className="legal-content-card">
                <div className="legal-notice" id="intro">
                  ...
                  <div>
                    <h2>Introduction</h2>
                    <p>BR30 Algo Terminal is provided to help users build a more structured trading workflow. By using the platform, you understand that automation tools are support systems and not profit-guarantee systems. You remain responsible for all trading decisions, broker activity, account usage, and financial outcomes.</p>
                  </div>
                </div>

                <div className="legal-section" id="usage">
                  {termsSections.slice(0, 4).map((item) => {
                ...
                <div className="legal-section" id="risk">
                  {termsSections.slice(4).map((item) => {
                    const Icon = item.icon;
                ...
                <div className="legal-rights">
                  ...
                  <p>Users must follow safe, lawful, and responsible usage practices while using BR30 Algo Terminal. The platform provides tools, but the final responsibility for trading, broker actions, account security, and risk control remains with the user.</p>
                ...
                <div className="legal-block" id="payment">
                  <div className="legal-block-icon">
                    <Scale size={24} />
                  </div>

                  <div>
                    <h3>7. Subscription, Pricing & Payments</h3>
                    <p>BR30 Algo Terminal may offer free, paid, trial, promotional, or custom plans. Pricing, features, limits, and availability may change from time to time. Users are responsible for reviewing plan details before purchase. Payment processing may be handled by third-party payment providers, and their own terms may apply.</p>
                  </div>
                </div>
                ...
                <div className="legal-block">
                  ...
                  <div>
                    <h3>8. Platform Availability & Updates</h3>
                    <p>We aim to keep BR30 Algo Terminal stable and accessible, but we do not guarantee uninterrupted availability. The platform may experience downtime, maintenance, broker API issues, server issues, technical errors, or feature changes. We may update, modify, pause, or remove features when required.</p>
                  </div>
                </div>
                ...
                <div className="legal-block">
                  ...
                  <div>
                    <h3>9. Prohibited Usage</h3>
                    <p>Users must not use BR30 Algo Terminal for illegal activity, unauthorized broker access, system abuse, spam, fraud, reverse engineering, scraping, security attacks, or any activity that may harm the platform, other users, brokers, infrastructure, or BR30 Group.</p>
                  </div>
                </div>

                <div className="legal-block" id="liability">
                  <div className="legal-block-icon">
                    <ShieldCheck size={24} />
                  </div>
                  ...
                  <div>
                    ...
                    <p>BR30 Algo Terminal, BR30 Group, its founder, team, partners, or service providers shall not be responsible for trading losses, broker errors, market volatility, technical failures, delayed execution, data inaccuracies, missed opportunities, account restrictions, API outages, or any direct or indirect losses caused by platform use.</p>
                  </div>
                </div>
                ...
                <div className="legal-block">
                  ...
                  <div>
                    ...
                    <p>We may update these Terms & Conditions from time to time to reflect product changes, operational needs, legal requirements, security updates, or business changes. Continued use of BR30 Algo Terminal after updates means you accept the revised terms.</p>
                  </div>
                </div>
                ...
                <div className="legal-contact" id="contact">
                  ...
                  <div>
                    ...
                    <p>For questions about these Terms & Conditions, platform access, account support, or legal-related queries, contact BR30 Algo Team at:</p>

                    <a href="https://mail.google.com/mail/?view=cm&fs=1&to=support.br30trader@gmail.com&su=Terms%20%26%20Conditions%20Query&body=Hello%20BR30%20Algo%20Team,%0A%0AI%20have%20a%20question%20regarding%20the%20Terms%20%26%20Conditions.%0A%0AThanks" target="_blank" rel="noopener noreferrer">
          ...
          <section className="legal-final-section">
            <div className="landing-container legal-final-card">
              ...
              <h2>Use BR30 Algo Terminal Responsibly</h2>

              <p>Build discipline, verify risk, test strategies, and understand the responsibility that comes with trading automation.</p>
...
.rights-grid svg{color:#22c55e;flex-shrink:0;}
